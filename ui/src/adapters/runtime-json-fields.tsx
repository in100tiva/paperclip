...
export function RuntimeServicesJsonField({
  ...
  return (
    <Field label="Runtime services JSON" hint={t("agents:config.help.runtime-services-json")}>
      <textarea
...
export function PayloadTemplateJsonField({
  ...
  return (
    <Field label="Payload template JSON" hint={t("agents:config.help.payload-template-json")}>
      <textarea
