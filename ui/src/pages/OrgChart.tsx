...
export function OrgChart() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("settings:org.crumb") }]);
  }, [setBreadcrumbs, t]);
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={Network} message={t("settings:org.select-company-chart")} />;
  }
  ...
  if (orgTree && orgTree.length === 0) {
    return <EmptyState icon={Network} message={t("settings:org.no-hierarchy")} />;
  }
      ...
      <div className="mb-2 flex shrink-0 flex-wrap items-center justify-start gap-2">
        <Link to="/company/import">
          <Button variant="outline" size="sm">
            ...
            {t("settings:org.import-company")}
          </Button>
        </Link>
        <Link to="/company/export">
          <Button variant="outline" size="sm">
            <Download className="mr-1.5 h-3.5 w-3.5" />
            {t("settings:org.export-company")}
          </Button>
        </Link>
      </div>
      <div
      ...
      >
        ...
        <div className="absolute top-3 right-3 z-10 flex flex-col gap-1.5">
          <button
            ...
            title={t("settings:org.zoom-in")}
            aria-label={t("settings:org.zoom-in")}
          >
          ...
          <button
            ...
            title={t("settings:org.zoom-out")}
            aria-label={t("settings:org.zoom-out")}
          >
          ...
          <button
            ...
            onClick={fitToScreen}
            title={t("settings:org.fit-to-screen")}
            aria-label={t("settings:org.fit-to-screen-aria")}
          >
