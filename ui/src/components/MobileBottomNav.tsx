...
export function MobileBottomNav({ visible }: MobileBottomNavProps) {
  ...
  const items = useMemo<MobileNavItem[]>(
    () => [
      { type: "link", to: "/dashboard", label: t("common:nav.mobile.home"), icon: House },
      { type: "link", to: "/issues", label: t("common:nav.items.issues"), icon: CircleDot },
      { type: "action", label: t("common:nav.mobile.create"), icon: SquarePen, onClick: () => openNewIssue() },
      { type: "link", to: "/agents/all", label: t("common:nav.mobile.agents"), icon: Users },
      {
        type: "link",
        to: "/inbox",
  ...
  return (
    <nav
      ...
      aria-label={t("common:nav.mobile.aria-label")}
    >
