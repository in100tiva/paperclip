...
export function NewAgentDialog() {
  ...
  function handleAskCeo() {
    ...
    openNewIssue({
      ...
      title: t("agents:new-agent-dialog.ceo-issue-title"),
      description: t("agents:new-agent-dialog.ceo-issue-description"),
    });
  }
            ...
            <>
              ...
              <div className="text-center space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  {t("agents:new-agent-dialog.ceo-recommendation")}
                </p>
              </div>

              <Button className="w-full" size="lg" onClick={handleAskCeo}>
                <Bot className="h-4 w-4 mr-2" />
                {t("agents:new-agent-dialog.ask-ceo-cta")}
              </Button>
              ...
              <div className="text-center">
                ...
                >
                  {t("agents:new-agent-dialog.advanced-link")}
                </button>
              </div>
            </>
          ) : (
            <>
              <div className="space-y-2">
                ...
                >
                  ...
                  {t("agents:new-agent-dialog.back")}
                </button>
                <p className="text-sm text-muted-foreground">
                  {t("agents:new-agent-dialog.advanced-prompt")}
                </p>
              </div>
                  ...
                  >
                    {opt.recommended && (
                      <span className="absolute -top-1.5 right-1.5 bg-green-500 text-white text-[9px] font-semibold px-1.5 py-0.5 rounded-full leading-none">
                        {t("agents:new-agent-dialog.recommended-tag")}
                      </span>
                    )}
